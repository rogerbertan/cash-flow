...
class GetCategoriesSummaryUseCaseTest {
    ...
    @InjectMocks private GetCategoriesSummaryUseCase useCase;
    ...
    void execute_ShouldReturnCategorySummaries_WhenTransactionsExist() {
        ...
        int month = 1;
        int year = 2025;
        CategorySummary summary1 =
                new CategorySummary("Salary", new BigDecimal("3000.00"), new BigDecimal("0.00"));
        CategorySummary summary2 =
                new CategorySummary("Food", new BigDecimal("0.00"), new BigDecimal("500.00"));
        CategorySummary summary3 =
                new CategorySummary("Transport", new BigDecimal("0.00"), new BigDecimal("200.00"));
    ...
    void execute_ShouldRoundAllSummaryValues_WhenDecimalsPresent() {
        ...
        int year = 2024;
        CategorySummary summary1 =
                new CategorySummary("Salary", new BigDecimal("100.555"), new BigDecimal("0.00"));
        CategorySummary summary2 =
                new CategorySummary("Food", new BigDecimal("0.00"), new BigDecimal("50.444"));
        ...
        assertThat(result.get(0).totalIncome())
                .isEqualByComparingTo(new BigDecimal("100.56").setScale(2, RoundingMode.HALF_UP));
        assertThat(result.get(0).totalExpense())
                .isEqualByComparingTo(new BigDecimal("0.00").setScale(2, RoundingMode.HALF_UP));
        assertThat(result.get(1).totalIncome())
                .isEqualByComparingTo(new BigDecimal("0.00").setScale(2, RoundingMode.HALF_UP));
        assertThat(result.get(1).totalExpense())
                .isEqualByComparingTo(new BigDecimal("50.44").setScale(2, RoundingMode.HALF_UP));
    ...
    void execute_ShouldPreserveCategoryNames_WhenMapping() {
        ...
        int year = 2024;
        CategorySummary summary1 =
                new CategorySummary("Salary", new BigDecimal("1000"), new BigDecimal("0"));
        CategorySummary summary2 =
                new CategorySummary("Groceries", new BigDecimal("0"), new BigDecimal("300"));
    ...
    void execute_ShouldReturnEmptyList_WhenNoCategoriesHaveTransactions() {
        ...
        int month = 12;
        int year = 2023;
        when(transactionGateway.getCategorySummaries(month, year))
    ...
    void execute_ShouldMapAllFieldsCorrectly_WhenTransforming() {
        ...
        int month = 8;
        int year = 2024;
        CategorySummary inputSummary =
                new CategorySummary("Food", new BigDecimal("100.555"), new BigDecimal("50.444"));
