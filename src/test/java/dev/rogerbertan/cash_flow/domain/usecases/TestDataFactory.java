...
public class TestDataFactory {
    ...
    public static CategoryUpdateRequest createCategoryUpdateRequest(Long id, String name, Type type, LocalDateTime createdAt) {
    ...
    public static TransactionUpdateRequest createTransactionUpdateRequest(
        ...
        return new TransactionUpdateRequest(id, type, amount, description, category, transactionDate, createdAt);
    }
    ...
    public static TransactionResponse createTransactionResponse(
        ...
        return new TransactionResponse(id, type, amount, description, categoryId, transactionDate, createdAt);
    }
    ...
    public static CategoriesSummaryResponse createIncomeCategoriesSummaryResponse() {
        return createCategoriesSummaryResponse("Salary", new BigDecimal("5000.00"), BigDecimal.ZERO);
    }
