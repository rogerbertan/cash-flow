...
class AIInsightsControllerTest {
    ...
    @Mock
    private GenerateSpendingInsightsUseCase generateSpendingInsightsUseCase;

    @Mock
    private SpendingInsightsMapper spendingInsightsMapper;
    ...
    @BeforeEach
    void setUp() {
        sampleInsights = new SpendingInsights(
        ...
        sampleResponse = new SpendingInsightsResponse(
    ...
    void getSpendingInsights_ShouldReturnInsights_WhenValidPeriodProvided() {
        ...
        ResponseEntity<SpendingInsightsResponse> response = controller.getSpendingInsights("monthly");
    ...
    void getSpendingInsights_ShouldHandleWeeklyPeriod() {
        SpendingInsights weeklyInsights = new SpendingInsights(
                List.of("Weekly insight"),
                "weekly",
                "Weekly summary",
                "raw"
        );
        SpendingInsightsResponse weeklyResponse = new SpendingInsightsResponse(
        ...
        ResponseEntity<SpendingInsightsResponse> response = controller.getSpendingInsights("weekly");
