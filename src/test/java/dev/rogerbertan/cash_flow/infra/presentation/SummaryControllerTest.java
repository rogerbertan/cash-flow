...
class SummaryControllerTest {
    ...
    @Mock
    private GetCategoriesSummaryUseCase getCategoriesSummaryUseCase;

    @Mock
    private BalanceResponseMapper balanceResponseMapper;

    @Mock
    private MonthlySummaryResponseMapper monthlySummaryResponseMapper;

    @Mock
    private CategorySummaryResponseMapper categorySummaryResponseMapper;
    ...
    void getMonthlySummary_ShouldPassCorrectParams_WhenCalled() {
        ...
        verify(getMonthlySummaryUseCase, times(1)).execute(monthCaptor.capture(), yearCaptor.capture());
    ...
    void getMonthlySummary_ShouldMapValueObjectToDTO_WhenReturning() {
        ...
        // Assert
        ArgumentCaptor<MonthlySummary> summaryCaptor = ArgumentCaptor.forClass(MonthlySummary.class);
    ...
    void getCategoriesSummary_ShouldReturnCategorySummaries_WhenValidParamsProvided() {
        ...
        CategoriesSummaryResponse response1 = TestDataFactory.createIncomeCategoriesSummaryResponse();
        CategoriesSummaryResponse response2 = TestDataFactory.createExpenseCategoriesSummaryResponse();
        ...
        // Act
        ResponseEntity<List<CategoriesSummaryResponse>> result = controller.getCategoriesSummary(month, year);
    ...
    void getCategoriesSummary_ShouldPassCorrectParams_WhenCalled() {
        ...
        CategoriesSummaryResponse response = TestDataFactory.createIncomeCategoriesSummaryResponse();
        ...
        ArgumentCaptor<Integer> monthCaptor = ArgumentCaptor.forClass(Integer.class);
        ArgumentCaptor<Integer> yearCaptor = ArgumentCaptor.forClass(Integer.class);
        verify(getCategoriesSummaryUseCase, times(1)).execute(monthCaptor.capture(), yearCaptor.capture());
    ...
    void getCategoriesSummary_ShouldMapListToDTO_WhenReturning() {
        ...
        when(getCategoriesSummaryUseCase.execute(month, year)).thenReturn(List.of(categorySummary));
        when(categorySummaryResponseMapper.toListDTO(List.of(categorySummary))).thenReturn(List.of(response));
    ...
    void getCategoriesSummary_ShouldReturnEmptyList_WhenNoSummariesExist() {
        ...
        when(categorySummaryResponseMapper.toListDTO(Collections.emptyList())).thenReturn(Collections.emptyList());
