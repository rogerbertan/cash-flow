...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAICategorizeException(AICategorizeException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleAIInsightsException(AIInsightsException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleBudgetPlannerException(BudgetPlannerException ex) {
